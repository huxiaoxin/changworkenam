...
- (IBAction)run:(id)sender {
    ...
    @autoreleasepool {
        ...
        self.basePath = @"/Users/codehzx/Desktop/XYZLike";
        ...
        // 删除注释
        BOOL needDeleteComments =YES;
        // 新旧工程名称
        BOOL needChangeProjectName = NO;
        NSString *oldProjectName = @"Booking";
        NSString *newProjectName = @"XYZLike";
        // 修改类名前缀
        BOOL needChangePrefix = NO;
        NSString *projectFilePath =
        [self.basePath stringByAppendingString:@"/Cardeal.xcodeproj"];
        NSString *oldClassNamePrefix = @"L";
        NSString *newClassNamePrefix = @"CAR";
        // 生成垃圾代码
        BOOL needGenerateSpamCode = NO;
        self.outDirString =
        [@"/Users/huzhixin/Desktop/垃圾代码" stringByAppendingString:@"/out"];
